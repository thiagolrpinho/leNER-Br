...
class Config():
    ...
    # general config
    dir_output = "model/results/prototype_revised/"
    ...
    # glove files
    filename_glove = "model/data/glove_s300.txt"
    # trimmed embeddings (created from glove_filename with build_data.py)
    filename_trimmed = "model/data/glove.6B.{}d.trimmed.npz".format(dim_word)
    use_pretrained = True
    ...
    filename_words = "model/data/words.txt"
    filename_tags = "model/data/tags.txt"
    filename_chars = "model/data/chars.txt"
