...
class Config():
    ...
    # general config
    dir_output = "assets/model_assets/model/prototype_revised/"
    ...
    # glove files
    filename_glove = "assets/model_assets/data/glove_s300.txt"
    # trimmed embeddings (created from glove_filename with build_data.py)
    filename_trimmed = "assets/model_assets/data/glove.6B.{}d.trimmed.npz".format(dim_word)
    use_pretrained = True
    ...
    filename_words = "assets/model_assets/data/words.txt"
    filename_tags = "assets/model_assets/data/tags.txt"
    filename_chars = "assets/model_assets/data/chars.txt"
